...
<p>Hi, I'm Jash! I'm a second-year MS student in Computer Science at the University of Illinois Urbana-Champaign, fortunate to be advised by <a href="https://hanj.cs.illinois.edu/" style="color: #1a3a6b; text-decoration: none;">Prof. Jiawei Han</a>.</p>
...
<table class="news-table">
  <tbody>
    ...
    <tr>
      <td class="news-emoji"><i class="fas fa-microphone news-icon-talk"></i></td>
      <td class="news-date">08.2026</td>
...
<div class="publications-list">
  ...
  year={2026}
        ...
        <a class="pub-btn" href="{{ base_path }}/files/cgr_poster.pdf" target="_blank">Poster</a>
        <a class="pub-btn" href="{{ base_path }}/files/cgr_presentation.pdf" target="_blank">Slides</a>
      </div>
    </div>
  </div>
